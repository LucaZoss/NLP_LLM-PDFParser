...
Your task is to go through this text file {term_sheet_test} and extract the value of the corresponding key elements listed here {elements_to_extract_value_from}. You can use {prompting_category} as context to find the values./
